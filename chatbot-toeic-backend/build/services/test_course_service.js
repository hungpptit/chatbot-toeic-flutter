...
const deleteCourseById = async courseId => {
  try {
    ...
    return {
      success: true,
      message: `Course ID ${courseId} deleted`
    };
  } catch (error) {
...
export { getAllTestsWithCourses, getAllCourseNames, getAllCoursesWithTests, updateCourseName, deleteCourseById, insertCourse };