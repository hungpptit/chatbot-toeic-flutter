import { getUserTestStats, getPartStatisticsByUser, getAccuracyOverTime, getUserTestHistory } from "../services/statistical_service.js";
...
const getUserTestHistoryController = async (req, res) => {
  try {
    ...
    res.status(500).json({
      message: 'Lỗi server khi lấy lịch sử làm bài.'
    });
  }
};
export { getUserTestStatsController, getPartStatisticsByUserController, getAccuracyOverTimeController, getUserTestHistoryController };