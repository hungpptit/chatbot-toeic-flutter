import { register, login, getUserFromToken, sendForgotPasswordOtp, resetPassword, sendRegisterOtp, verifyRegisterOtp } from '../services/login_signup_service.js';
...
const loginController = async (req, res) => {
  ...
  res.cookie('token', token, {
    ...
    secure: false,
    sameSite: 'Lax',
    // hoặc 'None' nếu frontend và backend khác domain và dùng HTTPS
...
export { registerController, loginController, getUserController, forgotPasswordController, resetPasswordController, sendRegisterOtpController, verifyRegisterOtpController };